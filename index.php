...
<head>
    ...
    <title>WorkShop - Adisanggoro</title>
...
<body>
    <div class="tm-container-fluid">
        ...
        <section class="tm-bgcolor-2 tm-p-50 mt-20" style="border-radius: 15px; margin-bottom: 20px;">
			...
			while ($x <= 5) {
			?>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quos nisi amet corporis recusandae repudiandae
                eos, eligendi ducimus tenetur suscipit enim beatae aliquam officia veniam ex hic distinctio accusantium,
                voluptatem dicta?</p>
            <?php
				$x++;
			}
        ...
        <section class="tm-about tm-mb-80 tm-p-50 tm-bgcolor-2 tm-border-rounded">
            ...
            <div class="tm-about-text">
                <p class="tm-mb-40">Nano Folio is simple HTML template with a minimal very light-weight custom CSS file.
                    Max content width is 940 pixels. You can easily change the width or any part in this template.
                    Gallery comes with a pop-up image and simple categories.</p>
                <p class="tm-mb-0">Please support Tooplate website by telling your friends about it. That is going to be
                    very helpful for us. Feel free to <a rel="nofollow" href="https://www.tooplate.com/contact"
                        target="_blank">message us</a> via email or live chat if you have anything to say.</p>
            </div>
        </section>
        ...
        <section class="tm-contact tm-mb-50 tm-bgcolor-3 tm-border-rounded">
            ...
            <div class="tm-contact-info">
                ...
                <div class="tm-text-white tm-mb-40">Tel: <a href="tel:0100200340" class="tm-link-white">010-020-0340</a>
                </div>
                <div class="tm-flex">
        ...
        <footer class="tm-footer">
            Copyright 2022 Fahreza Dahrudin - Design
        </footer>
    </div>
